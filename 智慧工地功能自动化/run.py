...
username['iotrack'] = 'admin'
password['iotrack'] = '123456'
username['organize'] = '19088880000'
password['organize'] = 'zh123456'
username['project_department'] = '19088880001'
password['project_department'] = 'zh123456'
...
if __name__ == '__main__':
    ...
    fp = open(filename, 'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp, title=u'智慧工地主要功能自动化测试', description=u'详细测试结果如下:')
    runner.run(cases)
    fp.close()
    # 向指定邮箱发送测试报告的html文件
    time.sleep(6)
